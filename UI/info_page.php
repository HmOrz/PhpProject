...
<div id="templatemo_container">
    ...
    <table width="100%" cellpadding="6" style="font-size:18px;">
        ...
        <tr>
          ...
          <td width="50%" align = "left"><input name="name" type="text" style="font-size:15px" id="name" value="<? echo"$row[name]"?>"></td>
		</tr>
        <tr>
		  <td align = "right">学&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：</td>
          <td align= "left"><input name="id" type="text" style="font-size:15px" id="id" value="<? echo "$row[no]" ?>" ></td>
        </tr>
        <tr>
